...
**Feature Distribution Analysis** (Figure 1):
The distribution visualization reveals several important characteristics of our extracted features:

Score Range: All features successfully populate the full [0,1] range, indicating the classifier is not saturating at extremes. This validates our zero-shot prompt design.
Variance & Discrimination: Features show healthy variance across sessions (typical IQR: 0.2-0.4), suggesting they capture meaningful differences in conversation quality rather than clustering around a single value. This discriminative power is essential for the downstream policy to differentiate between sessions.
Feature-Specific Patterns:

Question Ratio and Social Proof tend toward lower values (median ~0.3-0.4), reflecting that most conversations are assertion-heavy rather than inquiry-driven
Enthusiasm and Collaborative Score show higher medians (~0.6-0.7), indicating generally positive tone across sessions
Objection Handling displays the widest spread, consistent with it being a complex skill that varies significantly across learners


Outliers: A few sessions show extreme values (near 0 or 1) in specific features, representing either exceptional performance or clear skill gaps—exactly the signals our adaptive policy needs.

<img width="1006" height="461" alt="image" src="https://github.com/user-attachments/assets/8056917b-2e75-4d24-9426-3a636d7e08d8" />

**Feature Correlation Analysis** (Figure 2):
The correlation heatmap reveals the relationships between extracted features:

Moderate Positive Correlations:

Empathy Score ↔ Collaborative Score (r ≈ 0.5-0.6): Expected, as both reflect relational communication style
Objection Handling ↔ Empathy Score (r ≈ 0.4-0.5): Acknowledging concerns requires emotional awareness


Low Correlations: Most feature pairs show weak correlations (|r| < 0.3), indicating they capture orthogonal aspects of persuasion. This is ideal—redundant features would waste context dimensions without adding information.
Near-Independence: Question Ratio and CTA Clarity show minimal correlation with other features (|r| < 0.2), suggesting they measure distinct behavioral patterns (engagement tactics vs. conversion mechanics).
No Multicollinearity: The absence of strong correlations (r > 0.8) confirms that our feature set is not redundant. Each feature contributes unique signal to the 13-dimensional context vector used by LinUCB.

<img width="915" height="601" alt="image" src="https://github.com/user-attachments/assets/d3fdfc44-7cd1-4a44-b09b-6d16f79d25ea" />
...
- Safety constraint successfully enforced
  ...
  <img width="1008" height="508" alt="image" src="https://github.com/user-attachments/assets/806b24a6-5ab9-4a37-82f5-85f4b8412e24" />
...
<img width="1008" height="508" alt="image" src="https://github.com/user-attachments/assets/225b03f3-c8d4-472f-8721-54e8bf2ddec4" />

**Overlall score progression**

<img width="1076" height="508" alt="image" src="https://github.com/user-attachments/assets/bcb3e36e-6724-4d6d-9011-7fe5d707609d" />
...
<img width="1076" height="508" alt="image" src="https://github.com/user-attachments/assets/828c05a6-3a12-43f6-812b-55e5a6008b27" />
...
<img width="1076" height="508" alt="image" src="https://github.com/user-attachments/assets/3a12998d-6adb-4f25-a6ca-44a4bcdac15d" />

<img width="1076" height="508" alt="image" src="https://github.com/user-attachments/assets/2f51aff1-155f-4caf-ad31-e40431d180cc" />
...
<img width="1124" height="326" alt="image" src="https://github.com/user-attachments/assets/4724f93e-2d0b-4100-b661-03ff475ca2cb" />
...
<img width="1160" height="497" alt="image" src="https://github.com/user-attachments/assets/71c4653b-7154-4567-a461-1e09ae9d674b" />

<img width="1160" height="497" alt="image" src="https://github.com/user-attachments/assets/3393c1aa-fb21-48b3-a940-4adb0e863bfa" />
...
<img width="1153" height="224" alt="image" src="https://github.com/user-attachments/assets/b29a2c2d-806d-4ba4-8ae7-24542bbeee97" />
...
<img width="1132" height="493" alt="image" src="https://github.com/user-attachments/assets/efc73715-5908-4f9b-a45b-6dce94c316a3" />

<img width="1132" height="493" alt="image" src="https://github.com/user-attachments/assets/73524dc7-237d-4539-830e-46c3390baf1e" />
...
```
📍 Session 1:
   Selected Action: clarity
   Weakest Rubric Skill: active_listening (score: 19.0)
   Matches Weakest Rubric: ✗ NO
   LLM-Flagged Weaknesses: ['active_listening']
   Matches LLM Weakness: ✗ NO

   Rubric Scores:
      active_listening: 19.0
   👉 clarity: 43.0
      friendliness: 46.0
      call_to_action: 57.0
...
📍 Session 2:
   Selected Action: clarity
   Weakest Rubric Skill: active_listening (score: 40.0)
   Matches Weakest Rubric: ✗ NO
   LLM-Flagged Weaknesses: ['active_listening']
   Matches LLM Weakness: ✗ NO

   Rubric Scores:
      active_listening: 40.0
      friendliness: 52.0
      call_to_action: 60.0
   👉 clarity: 69.0
...
📍 Session 3:
   ...
   Weakest Rubric Skill: active_listening (score: 52.0)
   Matches Weakest Rubric: ✓ YES
   LLM-Flagged Weaknesses: ['active_listening']
   Matches LLM Weakness: ✓ YES

   Rubric Scores:
   👉 active_listening: 52.0
      clarity: 63.0
      call_to_action: 76.0
      friendliness: 86.0

📊 Overall Alignment Statistics:
   Matches Weakest Rubric: 21.1%
   Matches LLM Weakness: 26.3%
```
...
**Document prepared by**: Esra Brahmi  
